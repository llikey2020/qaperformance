...
kubectl exec alluxio-master-0 -c alluxio-master -- alluxio fs rm -RU /${SPARK_EVENTLOG_DIR} || true
...
helm uninstall spark-history-server stable/spark-history-server || true